...
export const API_ENDPOINTS = {
  ...
  transcriptRationale: {
    base: `${API_BASE_URL}/api/v1/transcript-rationale`,
    createJob: `${API_BASE_URL}/api/v1/transcript-rationale/create-job`,
    getJob: (jobId: string) => `${API_BASE_URL}/api/v1/transcript-rationale/jobs/${jobId}`,
    deleteJob: (jobId: string) => `${API_BASE_URL}/api/v1/transcript-rationale/jobs/${jobId}`,
    save: (jobId: string) => `${API_BASE_URL}/api/v1/transcript-rationale/jobs/${jobId}/save`,
    uploadSigned: (jobId: string) => `${API_BASE_URL}/api/v1/transcript-rationale/jobs/${jobId}/upload-signed`,
    downloadPdf: (jobId: string) => `${API_BASE_URL}/api/v1/transcript-rationale/jobs/${jobId}/download`,
    restartStep: (jobId: string, stepNumber: number) => `${API_BASE_URL}/api/v1/transcript-rationale/restart-step/${jobId}/${stepNumber}`,
    step5CsvPreview: (jobId: string) => `${API_BASE_URL}/api/v1/transcript-rationale/jobs/${jobId}/step5-csv-preview`,
    step5DownloadCsv: (jobId: string) => `${API_BASE_URL}/api/v1/transcript-rationale/jobs/${jobId}/step5-download-csv`,
    step5UploadCsv: (jobId: string) => `${API_BASE_URL}/api/v1/transcript-rationale/jobs/${jobId}/step5-upload-csv`,
    step5ContinuePipeline: (jobId: string) => `${API_BASE_URL}/api/v1/transcript-rationale/jobs/${jobId}/step5-continue-pipeline`,
    step5SaveEdits: (jobId: string) => `${API_BASE_URL}/api/v1/transcript-rationale/jobs/${jobId}/step5-save-edits`,
    failedCharts: (jobId: string) => `${API_BASE_URL}/api/v1/transcript-rationale/jobs/${jobId}/failed-charts`,
    uploadChart: (jobId: string, stockIndex: number) => `${API_BASE_URL}/api/v1/transcript-rationale/jobs/${jobId}/upload-chart/${stockIndex}`,
    step7ContinuePipeline: (jobId: string) => `${API_BASE_URL}/api/v1/transcript-rationale/jobs/${jobId}/step7-continue-pipeline`,
    skipFailedCharts: (jobId: string) => `${API_BASE_URL}/api/v1/transcript-rationale/jobs/${jobId}/skip-failed-charts`,
  },
  savedRationale: {
