...
- **Core Features**:
    ...
    - **Premium Rationale Pipeline**: An 8-step process for generating reports from text input (stock data fetching, technical/fundamental analysis, PDF generation). Step 3 includes intelligent CMP fallback (intraday price during market hours, historical closing price otherwise).
